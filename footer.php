						...
						<div class="flip-box">
							<div class="flip-box-inner">
								<div class="flip-box-front">
									<img  style="width:300px;height:200px" src="<?php echo esc_url(get_theme_mod('job_one_img',get_template_directory_uri().'/imgs/CEO.jpg')) ;?>">
								</div>
				...
				<div class="col">
					<div class="flip-outer">
						<div class="flip-box">
							<div class="flip-box-inner">
								<div class="flip-box-front">
									<img style="width:300px;height:200px" src="<?php echo esc_url(get_theme_mod('job_two_img',get_template_directory_uri().'/imgs/director.jpg') );?>">
				...
				<div class="col">
					<div class="flip-outer">
						<div class="flip-box">
							<div class="flip-box-inner">
								<div class="flip-box-front">
									<img style="width:300px;height:200px" src="<?php echo esc_url( get_theme_mod('job_three_img',get_template_directory_uri().'/imgs/designer.jpg')) ;?>"  >
				...
				<div class="col">
					<div class="flip-outer">
						<div class="flip-box">
							<div class="flip-box-inner">
								<div class="flip-box-front">
									<img style="width:300px;height:200px" src="<?php echo esc_url(get_theme_mod('job_four_img',get_template_directory_uri().'/imgs/developer.jpg')) ;?>">
