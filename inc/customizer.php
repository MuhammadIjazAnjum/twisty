<?php
	function twisty_customize_register($wp_customize){
		...
		// checkbox for first
		$wp_customize->add_setting( 'twisty_first_checkbox', array(
			'default'			=> true,
		    'sanitize_callback' => 'twisty_sanitize_checkbox',
			) );

		$wp_customize->add_control( 'twisty_first_checkbox', array(
		  'type' => 'checkbox',
		  'section' => 'team', // Add a default or your own section
		  'label' => __( 'Display first flipbox ' ),
		...
		// checkbox for second
		$wp_customize->add_setting( 'twisty_second_checkbox', array(
			'default'			=> true,
		    'sanitize_callback' => 'twisty_sanitize_checkbox',
			) );

		$wp_customize->add_control( 'twisty_second_checkbox', array(
		  'type' => 'checkbox',
		  'section' => 'team', // Add a default or your own section
		  'label' => __( 'Display second flipbox '),
		  // 'description' => __( 'This is a custom checkbox input.' ),
		  'priority' => 1,
		) );
		// Job two title
		...
		// Job two image
		 ...
		 //Third fipflop 
		$wp_customize->add_setting( 'twisty_third_checkbox', array(
			'default'			=> true,
		    'sanitize_callback' => 'twisty_sanitize_checkbox',
			) );

		$wp_customize->add_control( 'twisty_third_checkbox', array(
		  'type' => 'checkbox',
		  'section' => 'team', // Add a default or your own section
		  'label' => __( 'Display third flipbox '),
		  // 'description' => __( 'This is a custom checkbox input.' ),
		  'priority' => 1,
		) );
		// Job three title
		...
		// Job three image
		 ...
		 //Fourth fipflop 
		$wp_customize->add_setting( 'twisty_forth_checkbox', array(
			'default'			=> false,
		    'sanitize_callback' => 'twisty_sanitize_checkbox',
			) );

		$wp_customize->add_control( 'twisty_forth_checkbox', array(
		  'type' => 'checkbox',
		  'section' => 'team', // Add a default or your own section
		  'label' => __( 'Display forth flipbox '),
		  // 'description' => __( 'This is a custom checkbox input.' ),
		  'priority' => 1,
		  'default'	=> true,
		) );
	...
	function twisty_sanitize_checkbox( $checked ) {
	  // Boolean check.
